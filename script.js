        ...
        <section class="product-card" data-article-number="${product.articleNumber}">
          ...
          <div class="product-footer">
            ...
            <div class="product-meta">
              ...
              <div>
                <span>${product.isBulkPriceActive ? "Aktionspreis" : "Preis"}</span>
...
function renderRecommendedStatus(totalPacks) {
  ...
  if (difference > 0) {
    elements.recommendedStatus.textContent = `Noch ${formatNumber(difference)} Kartons bis zur empfohlenen Paketgröße`;
  } else if (difference < 0) {
    elements.recommendedStatus.textContent = `${formatNumber(Math.abs(difference))} Kartons über der empfohlenen Paketgröße`;
  } else {
